...
#
# Script generated by Vivado on Mon Sep 07 23:08:56 IST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : crc_core.sh
...
#
# Usage        : crc_core.sh
#                crc_core.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                crc_core.sh [-rerun]
#                crc_core.sh [-reset_run]
#                crc_core.sh [-clean]
#                crc_core.sh [-reset_log]
#                crc_core.sh [-help]
#
...
#                script (type 'crc_core.sh -help' for more information).
#
...
# script info
echo -e "crc_core.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./crc_core.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.crc_core xil_defaultlib.glbl -o crc_core_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./crc_core_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key crc_core_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc crc_core_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./crc_core.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: crc_core.sh [-help]\n\
Usage: crc_core.sh [-step]\n\
Usage: crc_core.sh [-lib_map_path]\n\
Usage: crc_core.sh [-rerun]\n\
Usage: crc_core.sh [-reset_run]\n\
Usage: crc_core.sh [-clean]\n\
Usage: crc_core.sh [-reset_log]\n\
Usage: crc_core.sh [-keep_index]\n\
Usage: crc_core.sh [-noclean_files]\n\n\
