...
#
# Script generated by Vivado on Sat Sep 19 10:48:32 IST 2026
...
#
# Usage        : crc_top.sh
#                crc_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                crc_top.sh [-rerun]
#                crc_top.sh [-reset_run]
#                crc_top.sh [-clean]
#                crc_top.sh [-reset_log]
#                crc_top.sh [-help]
#
...
#                script (type 'crc_top.sh -help' for more information).
#
...
# script info
echo -e "crc_top.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./crc_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../../../Lab\\ Assignments/Lab\\ 2/CRC16/CRC16.srcs/sources_1/new/CRC16.v" \
  "../../../../../../Lab\\ Assignments/Lab\\ 2/CRC16/CRC16.srcs/sources_1/new/CRC_CORE.v" \
  "../../../../../../Lab\\ Assignments/Lab\\ 2/CRC16/CRC16.srcs/sources_1/new/CRC_RX.v" \
  "../../../../../../Lab\\ Assignments/Lab\\ 2/CRC16/CRC16.srcs/sources_1/new/CRC_TX.v" \
  "../../../../../../Lab\\ Assignments/Lab\\ 2/CRC16/CRC16.srcs/sources_1/new/CustomBuff.v" \
  "../../../../../../Lab\\ Assignments/Lab\\ 2/CRC16/CRC16.srcs/sources_1/new/MSG_MEM.v" \
  "../../../../../../Lab\\ Assignments/Lab\\ 2/CRC16/CRC16.srcs/sources_1/new/SERIALIZER.v" \
  "../../../../../../Lab\\ Assignments/Lab\\ 2/CRC16/CRC16.srcs/sources_1/new/CRC_TOP.v" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.crc_top xil_defaultlib.glbl -o crc_top_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./crc_top_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/agnibha/Documents/acads/Reconfig/Lab"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key crc_top_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc crc_top_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./crc_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: crc_top.sh [-help]\n\
Usage: crc_top.sh [-step]\n\
Usage: crc_top.sh [-lib_map_path]\n\
Usage: crc_top.sh [-rerun]\n\
Usage: crc_top.sh [-reset_run]\n\
Usage: crc_top.sh [-clean]\n\
Usage: crc_top.sh [-reset_log]\n\
Usage: crc_top.sh [-keep_index]\n\
Usage: crc_top.sh [-noclean_files]\n\n\
